            ...
            <div className="vacation-calendar-header">
                <div className="vacation-calendar-navigation">
                    ...
                    <div className="vacation-calendar-current-month">
                        ...
                        <button className="vacation-calendar-today-button" onClick={goToToday}>
                            Hoy
                        </button>
                    </div>
            ...
            <div className="vacation-calendar-grid">
                ...
                <div className="vacation-calendar-days">
                    {days.map((day, index) => (
                        <div
                            key={index}
                            className={`vacation-calendar-day ${!day.isCurrentMonth ? 'vacation-calendar-other-month' : ''
                                } ${day.date.toDateString() === today.toDateString() ? 'vacation-calendar-today' : ''
